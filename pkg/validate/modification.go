...
func preventReleasedChartModifications(configYaml ConfigurationYaml) []error {
	...
	fmt.Printf("directoryComparison.Added: %v\n", directoryComparison.Added)
	fmt.Printf("directoryComparison.Modified: %v\n", directoryComparison.Modified)
	fmt.Printf("directoryComparison.Removed: %v\n", directoryComparison.Removed)
